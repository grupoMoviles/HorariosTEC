...
public class Teachers_Activity extends Activity implements SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    ...
    public boolean onClose() {
        Teachers_Activity.this.adapter.filter("");
        return false;
    }
    ...
    public boolean onQueryTextChange(String query) {
        Log.e("SEARCH", query);
        Teachers_Activity.this.adapter.filter(query);
        return false;
    }
    ...
    class AsyncGetTeachers extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String feed) {
            adapter = new TeacherInfoAdapter(getApplicationContext(),teacher_list);
