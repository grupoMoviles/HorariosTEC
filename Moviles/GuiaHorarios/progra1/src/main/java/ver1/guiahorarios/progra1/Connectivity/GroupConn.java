...
public class GroupConn {
    ...
    public void postData(String pCourseCode) throws JSONException, IOException {
    ...
    public void getSpecificGroup(String pCodigo,int pNumero) throws JSONException, IOException {
        ...
        Log.e("GET SPECIFIC GROUP","LLEGA");
        ...
        Log.e("GET SPECIFIC GROUP","JSON");
        Log.e("GET SPECIFIC GROUP",result);
        ...
        Log.e("GET SPECIFIC GROUP","LLENA GRUPO");
    ...
    public void getGroups(JSONArray array) throws JSONException {
        for(int i = 0; i< array.length();i++)
        {
            ...
            Log.e("CODIGO",array.getJSONObject(i).getString("codigo"));
            Log.e("NUMERO",Integer.toString(array.getJSONObject(i).getInt("numero")));
        }
    }
